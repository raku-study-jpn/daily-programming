...
![リストのイメージ](2025-11\11-9\images\image_1.png)

これに対して Linked List（連結リスト） は少し仕組みが異なります。
データ（ノード）がそれぞれバラバラの場所（メモリアドレス）にあり、
各ノードが「次のノードはどこか」を ポインタ（参照）として記憶 しています。
...
![Linked Listのイメージ](2025-11\11-9\images\image_2.png)
